                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input type="number" name="year" dafaultValue={new Date().getFullYear()}/>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-2">
                        ...
                        <button onClick={() => setIsOpen(false)} disabled={loading} type='submit' className='btn-seconddary flex items-center'>
