      ...
      <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in' onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className='p-6 space-y-5'>
          ...
          <div className="flex gap-3 pt-2">
            <button onClick={onClose} type='button' className="btn-secondary flex">
              Cancel
            </button>
            <button onClick={onClose} disabled={loading} type='button' className="btn-secondary flex-1 flex items-center justify-center gap-2">
